...
\begin{itemize}
    ...
    psutil~\cite{psutil}, resource~\cite{importlib_resources}, tracemalloc~\cite{tracemalloc}, \DFTODO{Adicionar todas as dependências}, and custom scripts for memory monitoring.
\end{itemize}
